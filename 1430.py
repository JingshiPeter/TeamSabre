...
#	return rhs <= model.Trainer[p,b,t]
...
def training_rule_onwork(model,p,r,f,b,t):
	if (p,r,f,b) in model.all_var_set:
		return model.Yonwork[p,r,f,b,t] <= model.Trainer_pos[p,r,f,b,t]
	else:
		return pe.Constraint.Skip
...
def trainee_rule2_onwork(model,p,r,f,b,t):
	if (p,r,f,b) in model.all_var_set:
		return  model.Yonwork[p,r,f,b,t] <= model.Trainee_pos[p,r,f,b,t]
	else:
		return pe.Constraint.Skip
...
def demand_rule(model,r,f,b,t):
	...
	for p in model.trainer_pilots :
		if (p, r, f, b) in model.all_var_set:
			vp +=model.Trainer_pos[p, r, f, b, t]

	traineep=0
	for p in model.fleet_pilots :
		if (p, r, f, b) in model.nonfix_var_set:
			vp +=model.Trainee_pos[p, r, f, b, t]
	vfixp=0
...
def vacation_position_rule_onwork(model,p,r,f,b,t):
	return model.Yonwork[p,r,f,b,t] <= model.Vnonfix_position[p,r,f,b,t]

		...
		for b in model.base:
			for t in model.time:
				if(model.shortage[r,f,b,t].value != 0):
					print "shortage in {} {} {} in week {} is {}".format(r,f,b,t,model.shortage[r,f,b,t].value)
					print "shortage in" + r + f + str(b) + str(t) +" is " + str(model.shortage[r,f,b,t].value)
				if(model.surplus[r,f,b,t].value != 0):
					print "surplus in" + r + f + str(b) + str(t) +" is " + str(model.surplus[r,f,b,t].value)

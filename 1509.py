...
#		for r in model.rank:
#			if (p,r,f,b) in model.all_var_set:
#				rhs=rhs+model.Ynowork[p,r,f,b,t]
...
model.OBJ = pe.Objective(expr = model.total_shortage_cost + model.total_trans_cost + model.total_vacation_penalty + model.operationcost - model.operationminus - model.total_seniority_reward - model.total_vacation_reward, sense=pe.minimize)

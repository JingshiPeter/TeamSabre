...
model.training_constraint = pe.Constraint(model.trainer_pilots*model.positions*model.time,rule = training_rule)
#
def training_rule_onwork(model,p,r,f,b,t):
	if (p,r,f,b) in model.all_var_set:
		...
		return pe.Constraint.Skip
model.training_constraint_onwork = pe.Constraint(model.trainer_pilots*model.positions*model.time,rule = training_rule_onwork)
...
def trainee_rule2_onwork(model,p,r,f,b,t):
	if (p,r,f,b) in model.all_var_set:
		...
		return pe.Constraint.Skip
model.trainee_constraint2_onwork = pe.Constraint(model.fleet_pilots*model.positions*model.time, rule = trainee_rule2_onwork)

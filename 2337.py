...
for (p, r, f, b) in model.fix_var_set:
	...
	if len(vacation_times) != 0 :
		...
		if len(vacation_times) > 8:
			idle_warning += "***"
		print "{}pilot {} , {} {} at base{} has vacations in {}".format(idle_warning,p,f,r,b,out)
		...
		for r in model.rank:
			...
			for t in model.time:
				...
				if(model.surplus[r,f,b,t].value != 0):
					print "surplus in {} {} base {} in week {} is {}".format(r,f,b,t,model.surplus[r,f,b,t].value)
			if len(short_times) != 0 :
				...
				if len(short_times) > 5:
					short_warning += "***"
				print "{} @ base {}, {} {} has shortage in weeks : {}".format(short_warning, b,f,r,out)
				print "shortages are {}\n".format(values)
